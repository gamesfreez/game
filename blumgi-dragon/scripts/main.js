...
window.RuntimeInterface = class a {
    ...
    async _Init(b) {
        ...
        b.runtimeBaseUrl ? this._runtimeBaseUrl = b.runtimeBaseUrl : (c = location.origin,
            ...
            c = this._runtimeBaseUrl.lastIndexOf("/"), -1 !== c && (this._runtimeBaseUrl = this._runtimeBaseUrl.substr(0, c + 1)));
...
self.AudioDOMHandler = class extends self.DOMHandler {
    ...
    _SetEffectParam(a) {
        ...
        a = a.time;
        for (const g of b)
            b = this._effects.get(g.toLowerCase()), !b || 0 > c || c >= b.length || b[c].SetParam(d, e, f, a);
        this._PostUpdatedFxState()
    }
    _RemoveEffects(a) {
        a = a.tags;
